...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B83lqDlj.mjs");
...
const manifest = {
  "3c64988934d7bd1d0cd30dfde5cd832298947c4e0ce9234ab57b3581bd2d61f7": {
    functionName: "submitAsset_createServerFn_handler",
    importer: () => import("./submission.functions-B8fdJfBC.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BOowU5Nw.mjs").then((n) => n.r),
    import("./start-COq8CQXN.mjs"),
